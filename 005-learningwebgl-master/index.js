(function() {
  ...
  function main() {
    ...
    function onKeyDown(event) {
      ...
      if(event.keyCode == 189) thetaSpeed -= 0.01; //189 itu keycode-nya '-'
      else if(event.keyCode == 187) thetaSpeed += 0.01; //187 itu keycode-nya '='
      else if(event.keyCode == 48) thetaSpeed = 0.0; //48 itu keycode-nya '0'
    }
    document.addEventListener('keydown', onKeyDown);

    // Definisi matriks pandangan (view matrikx)
    ...
    // Definisi matrikx proyeksi perspektif
